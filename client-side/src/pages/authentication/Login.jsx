    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          type="button"
          onClick={() => googleLogin()}
          className="group w-full inline-flex items-center justify-center rounded-xl bg-white border border-gray-300 px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
        >
